...
describe("Source Selector Component", function () {
    ...
    describe("source Selector Parent Component", function () {
        ...
        it("should render correctly", function () {
            const wrapper = shallow(<SourceSelector source={undefined} sources={sources} setLoading={undefined} goTo={undefined} getSources={undefined} setSource={undefined} removeSource={undefined} setAmazonFlow={undefined} amazonFlow={undefined} finishLoading={undefined} user={undefined} />);
